...
proxyForwardTo = (str(Rhost),int(Rport))
...
#
# Re-implement this method, if you use authentication!
...
try:
	print ('-------------------------------------')
	print(' * port forward berhasil')
	print(' * local port proxy: ' + str(proxyPort))
	print(' * remote ke :' + str(proxyForwardTo[0]) + ': ' + str(proxyForwardTo[1]))
	print ('-------------------------------------')
	print (' !! ketik ctrl + c, untuk keluar')
	print ('-------------------------------------')
	proxy.main_loop()
